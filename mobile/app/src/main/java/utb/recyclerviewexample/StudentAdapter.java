...
public class StudentAdapter extends RecyclerView.Adapter<FeedListRowHolderStudent> {

    private List<StudentItem> studentItemList;
    private Context mContext;

    public StudentAdapter(Context context, List<StudentItem> studentItemList) {
    ...
    public void onBindViewHolder(FeedListRowHolderStudent feedListRowHolderStudent, int i) {
        ...
        feedListRowHolderStudent.student_name.setTag(Html.fromHtml(studentItem.getUri()));
    }
